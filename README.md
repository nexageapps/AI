...
| Basic (L4) | [Basic L4 - Byte Pair Encoding [BPE].ipynb](Basic L4A - Byte Pair Encoding [BPE] with tokenizers.ipynb) | Introduction to Byte Pair Encoding (BPE) tokenization used in NLP. |
