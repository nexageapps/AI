...
Output dimension: 2 x hidden_size` },
  ...
  },
  {
    ...
    icon: FaEye,
    content: [
      { type: 'text', value: 'The attention mechanism allows an RNN to focus on specific parts of the input that are most relevant for each output step, rather than compressing the entire input into a single fixed-size vector (CS230).' },
      ...
      { type: 'text', value: 'The energy scores e^<t,t\'> are computed by a small neural network that takes the decoder hidden state and encoder activation as inputs. This is sometimes called Bahdanau attention.' },
      { type: 'examples', items: [
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'text', value: 'References: Stanford CS230 (stanford.edu/~shervine/teaching/cs-230/), Stanford CS231n 2017 (cs231n.stanford.edu). Content was rephrased for compliance with licensing restrictions.' },
    ],
  },
];
