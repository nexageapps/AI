...
[View MAI Student Guide](./MAI_STUDENT_GUIDE.md)
...
[View Exam Preparation Guide](./EXAM_PREPARATION_GUIDE.md)
...
[View Progress Tracker Guide](./PROGRESS_TRACKER_GUIDE.md)
...
[View Academic Integrity Policy](./ACADEMIC_INTEGRITY.md)
...
### I'm a new visitor
Start with [README.md](./README.md) to understand the repository structure and learning paths.

### I'm a UoA MAI student
Read the [MAI Student Guide](./MAI_STUDENT_GUIDE.md) for course-specific guidance and semester planning.

### I'm preparing for exams
Check the [Exam Preparation Guide](./EXAM_PREPARATION_GUIDE.md) for study strategies and practice problems.

### I want to track my progress
See the [Progress Tracker Guide](./PROGRESS_TRACKER_GUIDE.md) for effective tracking methods.

### I want to understand recent changes
Review the [Updates Summary](./UPDATES_SUMMARY.md) for all recent enhancements.

### I want to contribute
Read the [Contributing Guidelines](./CONTRIBUTING.md) for contribution process.

### I need to cite this repository
Check the [Academic Integrity Policy](./ACADEMIC_INTEGRITY.md) for citation guidelines.
